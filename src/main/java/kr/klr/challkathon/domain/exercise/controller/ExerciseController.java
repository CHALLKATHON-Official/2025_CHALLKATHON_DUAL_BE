...
public class ExerciseController implements ExerciseControllerSpec {
    ...
    @GetMapping("/indoor")
    public GlobalApiResponse<ExerciseListRes> getIndoorExercises(
    ...
    @PostMapping("/record")
    public GlobalApiResponse<ExerciseRecordRes> recordExercise(
            @CurrentUser String userUid,
    ...
    public GlobalApiResponse<List<ExerciseRecordRes>> getTodayExerciseRecords(
            @CurrentUser String userUid) {
    ...
    @GetMapping("/records")
    public GlobalApiResponse<List<ExerciseRecordRes>> getExerciseRecords(
            @CurrentUser String userUid,
